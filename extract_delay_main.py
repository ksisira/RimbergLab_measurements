...
par_array.append([line()-line0,"Manual dng", 0.03])
par_array.append([line()-line0,"Additional voltage divider", 11])
...
[date, bias_point, bias_point_bg, temp, photons, feed_bool, twpa_state, 
 ...
 bp_volt,manual_dng,PID_VD]=parameters
...
#        bias[1] = ng_dc_feed_mean
    ...
    setup_parameters = [photons, bias, temp, mod_volt, sens, tc_feed, 
                        ...
                        gate_voltage_divider, manual_dng, PID_VD]
    offset_y = mm.extract_delay(directory_name, setup_parameters, 
                                inst_call)
    ng_feed_corrected_array.append(bias[1])
