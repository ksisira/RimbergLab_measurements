...
Measure charge noise at very low pump power.
...
Manually set:
    1. Connect signal generator to BCOM through the cables used for PModulator
    connections.
    2. Connect B0 to A1.
...
directory_name=('../{}_{}_{}_{}_charge_noise_{}_mK_{}_ng_{}_phi0_{}_photons'.
...
carrier_power_est = sa_J0_power_est
...
mod_freq=30e6 #this is disconnected anyway.
mod_volt=0.181 #this is disconnected anyway.
