...
directory_name=('../{}_{}_{}_{}_ng_error_sweep_{}_mK_{}_ng_{}_phi0_{}_photons'.
...
if ng_sweep_state:
    ...
    essng_params = [photons, bias, temp, mod_freq, mod_volt, res_freq_meas,
                    ...
                    clock_rate, sample_rate_sweep, acq_no_sweep, acq_time,
...
"""Optimize PID"""
fit_data = 'Y'
sim_params = [photons, bias, temp, tc_feed, vna_power_dBm, input_att_dB,
              kappa_int, kappa_ext, delay]
(res_power, res_Y, out) = mm.optimize_pid(directory_name, sim_params)

"""Error signal Setup with lower time constant"""
