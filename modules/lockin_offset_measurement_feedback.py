...
def lockin_offset(directory_name, parameters, inst_call, feed_str = ''):
    directory_name_off = directory_name + '/Lockin_offset' + feed_str
    ...
    [photons, bias, temp, mod_volt,
     ...
     carrier_power, mod_freq, gate_voltage_divider] = parameters
